...
researchB includes a local reference shelf for manuals, encyclopedias, field
...
researchB accepts only a loopback embedding endpoint. A remote director/model
